...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='mittal2927@2006',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://portfolio-wine-five-14.vercel.app/" style="text-decoration: none; color: #021659;">Lalit mittal</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Lalit mittal</a>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'lalit29' and ad_password == 'mittal2927':
                ...
                st.success("Welcome Lalit ! Total %d " % values + " User's Have Used Our Tool : )")                
